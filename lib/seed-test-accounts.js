...
const DATABASE_URL =
  'postgresql://neondb_owner:npg_Qat9SxdPXgu7@ep-dawn-feather-adw83aaz-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require';
    ...
    for (const acc of ACCOUNTS) {
      ...
      await client.query(
        `INSERT INTO auth.users (id, email, password_hash, raw_user_meta_data)
         VALUES ($1, $2, $3, $4)`,
        [userId, acc.email, passwordHash, JSON.stringify(meta)]
      );
